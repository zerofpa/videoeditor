...
def main():
    input_directory = input("Enter the path to the input directory containing videos: ")
    output_directory = input("Enter the path to the output directory for processed videos: ")
    llm_prompt = input("Enter the prompt to generate editing rules: ")

    # Process videos in batches
    process_videos(input_directory, output_directory, llm_prompt, batch_size=1)
